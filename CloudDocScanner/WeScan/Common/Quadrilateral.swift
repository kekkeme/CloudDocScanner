...
public struct Quadrilateral: Transformable, Codable {
...
extension Quadrilateral {
    ...
    func difference(prevQuad: Quadrilateral) -> Double {
       let topLeftDiff = self.topLeft.distanceTo(point: prevQuad.topLeft)
       let topRightDiff = self.topRight.distanceTo(point: prevQuad.topRight)
       let bottomLeftDiff = self.bottomLeft.distanceTo(point: prevQuad.bottomLeft)
       let bottomRightDiff = self.bottomRight.distanceTo(point: prevQuad.bottomRight)
        
        return Double(topLeftDiff + topRightDiff + bottomLeftDiff + bottomRightDiff)
    }
