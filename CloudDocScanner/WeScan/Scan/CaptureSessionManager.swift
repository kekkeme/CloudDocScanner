...
//                deviceInput.device.activeVideoMinFrameDuration = (bestFrameRateRange?.minFrameDuration)!
//                deviceInput.device.activeVideoMaxFrameDuration = (bestFrameRateRange?.minFrameDuration)!
...
//        }
    ...
    internal func start() {
        ...
        case .authorized:
            ...
            isDetecting = true
            let error = ImageScannerControllerError.authorized
            delegate?.captureSessionManager(self, didFailWithError: error)
        case .notDetermined:
